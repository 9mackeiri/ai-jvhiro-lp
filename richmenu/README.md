...
| 2（右上） | TikTok | 1250 | 0 | 1250 | 843 | リンク | https://www.tiktok.com/@ai_jvhiro |
| 3（左下） | note | 0 | 843 | 1250 | 843 | リンク | https://note.com/ai_jvhiro |
| 4（右下） | 質問する／そのまま送ってOK | 1250 | 843 | 1250 | 843 | テキスト | 質問があります |

- 「テキスト」は、タップした人のトーク画面にその文が送信されるアクション。応答メッセージ（キーワード応答）で
  「質問があります」への返事を用意しておくと自然
